...
class DashboardHomeRangeOfPattern extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemCount: c.bottomRepoModel.value!.rangeOfPattern!.length,
                ...
                children: [
                  SizedBox(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: c.bottomRepoModel.value!.rangeOfPattern![index]
                          .image!,
                      fit: BoxFit.cover,
                  ...
                  Positioned(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          c.bottomRepoModel.value!.rangeOfPattern![index]
                              .name,
